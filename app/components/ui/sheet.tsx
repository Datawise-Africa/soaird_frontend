  ...
  return (
    <SheetPrimitive.Portal data-slot="sheet-portal">
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'fixed z-50 flex flex-col gap-4 overflow-y-auto border-border bg-card p-6 text-card-foreground shadow-2xl shadow-black/50 transition ease-in-out data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:animate-in data-[state=open]:duration-500',
          SIDE[side],
          className
        )}
        {...guardProps}
