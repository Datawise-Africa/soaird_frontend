...
function DialogContent({
  ...
  /**
   * Prevent closing on outside-click and Escape — use for forms with unsaved
   * input so a stray click doesn't discard it. The close button (or a Cancel
   * handler) is then the only way out.
   */
